...
def main(request_list,regenerators,slotsNo,totReqSlot):
    with open('./EE_RMSA-NEW/NETWORKS/adjmat_1.txt', 'r', encoding='utf-8') as f: #'./NETWORKS/adjmat_1.txt'
        contents = f.read()
    ...
    with open(request_list, 'r', encoding='utf-8') as file: #'./REQUESTS/NewRequests24/Fixed-80/500_Fixed-80_24.txt'
    ...
    for one_request_str in request_list_str:
        ...
        blocked_or_new_tree = rb.check_optical_reach_blocking(
            paths_dist, paths, regeneration_resources_copy, adj_matrix)
        ...
        if blocked_or_new_tree is True:
            ...
            if psudoSlotsLink is True:
                ...
                # print("New Regeneration Resources List: ",regeneration_resources)
    ...
    print("\n\033[33m----:ANALYSIS:----ALGO 1----\033[0m\n")
    # print("Total Requests: ",tot_requests)
    # print("Total Blocked: ", num_blocked_request)
    ...
    # print("Total number of Regeneration Happened = ",len(adj_matrix)*regenerators - sum(regeneration_resources.values()))
    ...
    #highest index of spectrum slot
