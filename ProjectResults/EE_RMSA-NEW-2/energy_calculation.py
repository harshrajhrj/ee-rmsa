...
def amplifier_energy(slots_list,paths,adj_matrix,slotno):
    tot_energy=0
    for idx,tot_path in enumerate(paths):
        ...
        tot_pow_given_slot=slots/slotno*each_path_energy
        tot_energy+=tot_pow_given_slot
    return tot_energy

def crossConnect_energy(slots_list,paths,node_degree,slotno):
