...
def main(request_list,regenerators,slotsNo,totReqSlot):
    with open(
        "./EE_RMSA-NEW-2/NETWORKS/adjmat_1.txt", "r", encoding="utf-8"   
    ) as f:  #'./NETWORKS/adjmat_1.txt'
        contents = f.read()
    ...
    # print("Each link has", , "slots")

    #############################################################################################
    # finding regeneration nodes
    max_regeneration = 1
    # print("Each Regenerating node has", st.REGENRESOURCESAVAILABLE, "resources.")
    # print("Optical Reach: ", st.OPTICAL_REACH)
    ...
    with open(request_list, "r", encoding="utf-8") as file:  #'requests.txt', './REQUESTS/networknodes24/300_VSD_24.txt'
    ...
    for one_request_str in request_list_str:
        ...
        blocked_or_new_tree = st.sTree(adj_matrix, new_request, regeneration_resources_copy,max_regeneration,regenerators)
        # print("\n\033[32mCREATING STEINER TREE...\033[0m")
        # print("All the segment present in the Tree: ", blocked_or_new_tree[1])
        # print("Total Distance of each respective segments: ", blocked_or_new_tree[0])
        # print("The Steiner Tree: ", blocked_or_new_tree[4])
        ...
        if blocked_or_new_tree is True:
            ...
            # print(
            #     "All the segment present in the Tree after Regeneration: ",
            #     blocked_or_new_tree[1],
            # )
            # print("Total Distance of each respective segments: ", blocked_or_new_tree[0])
            # print("Regeneration happened at nodes: ", blocked_or_new_tree[3])
            # print("The Steiner Tree: ", blocked_or_new_tree[4])
            # print("Max regeneration : ",blocked_or_new_tree[5])
            ...
            if psudoSlotsLink is True:
                ...
                max_regeneration = blocked_or_new_tree[5]


                # ENERGY USED: TO SERVE THE REQUEST
                energy_bvt = ec.slotsEnergyBVT(slots_required, blocked_or_new_tree[0])
                ...
                # print(
                #     "TOTAL ENERGY USED BY THE REQUEST: ",
    ...
    #     "\033[35m############################################################################################################################...\033[0m"
    # )
    print("\n\033[33m----:ANALYSIS:----ALGO 4----\033[0m\n")
    # print("Total Requests: ",tot_requests)
    # print(
    #     "Total Blocked: Number of blocked request inavailability of slots or regeneration: ",
    #     num_blocked_request,
    # )
    # print(
    #     "Number of request blocked due to regeneration problem: ",
    ...
    # print(
    #     "Total number of Regeneration Happened = ",
    #     len(adj_matrix) * st.REGENRESOURCESAVAILABLE - sum(regeneration_resources.values()),
    # )


    # print(
    #     "After serving all the request the number of regeneration resources for each regeneration nodes: ",
    ...
    max_regen_time = regenerators - regeneration_resources[max_regen_node]
