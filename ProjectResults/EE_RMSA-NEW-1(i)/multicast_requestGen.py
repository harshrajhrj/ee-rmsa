...
def main(request_list,regenerators,slotsNo,totReqSlot):
    with open('./EE_RMSA-NEW-1(i)/NETWORKS/adjmat_1.txt', 'r', encoding='utf-8') as f: #'./NETWORKS/adjmat_1.txt'
        contents = f.read()
    ...
    for one_request_str in request_list_str:
        ...
        blocked_or_new_tree = rb.check_optical_reach_blocking_min_freqslot(
            paths_dist, paths, regeneration_resources_copy, adj_matrix,bandW)
        ...
        if blocked_or_new_tree is True:
            ...
            if psudoSlotsLink is True:
                ...
                # print("Link by slots: ")
                # for item,values in slotsLink.items():
                #     print(item,"-->",sum(values),end="")
    ...
    print("\n\033[33m----:ANALYSIS:----ALGO 2----\033[0m\n")
